...
BUILD_SETTINGS = BazelBuildSettings(
    '/usr/local/bin/bazel',
    '/private/var/tmp/_bazel_slaf/e893582cfc848a9f4e2f4d32eefbfdf8/execroot/__main__',
    'ios_x86_64',
    {
        'tvos_arm64': [
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/slaf/Library/Application Support/Tulsi/0.20210318.88/Bazel',
